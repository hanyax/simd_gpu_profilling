...
import onnxruntime
from onnxruntime.quantization import CalibrationDataReader, create_calibrator, write_calibration_table, CalibrationMethod, QuantType, QuantizationMode, QDQQuantizer
import time
import json
...
if __name__ == '__main__':
    ...
    quant_model_path = sys.argv[1]
    batch_size = 1
    calibration_dataset_size = 10  # Size of dataset for calibration
    ...
    input_name = convert_model_batch_to_dynamic(quant_model_path)
    ...
    evaluator = ImageClassificationEvaluator(quant_model_path, data_reader, providers=execution_provider)
    evaluator.predict()
